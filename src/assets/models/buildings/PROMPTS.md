...
Zielordner: `src/assets/models/buildings/<kategorie>/`, **Dateiname = Gebäude-ID**. Jeder Block ist copy-paste-fertig (Stil-Prefix + Motiv). **Technik (Pflicht):** `.glb`, Texturen eingebettet, keine Lichter/Kameras, +Y oben, Front +Z, Pivot mittig an der Unterkante, 1 Tile = 1 Welt-Einheit. Stil-Details & Budgets: `docs/3D_WORLD_ASSETS.md`.
...
```
> Stufen: `town_hall_stage2`…`town_hall_stage4` (sichtbar weiterentwickelt) · Baustelle: `town_hall_construction.glb`
...
```
> Baustelle optional: `mayor_house_construction.glb`
...
```
> Baustelle optional: `district_center_construction.glb`
...
```
> Stufen: `house_small_stage2`…`house_small_stage6` (sichtbar weiterentwickelt) · Baustelle: `house_small_construction.glb`
...
```
> Stufen: `house_row_stage2`…`house_row_stage3` (sichtbar weiterentwickelt) · Baustelle: `house_row_construction.glb`
...
```
> Stufen: `apartment_stage2`…`apartment_stage3` (sichtbar weiterentwickelt) · Baustelle: `apartment_construction.glb`
...
```
> Stufen: `residential_tower_stage2`…`residential_tower_stage3` (sichtbar weiterentwickelt) · Baustelle: `residential_tower_construction.glb`
...
```
> Stufen: `sawmill_stage2`…`sawmill_stage4` (sichtbar weiterentwickelt) · Baustelle: `sawmill_construction.glb`
...
```
> Stufen: `quarry_stage2`…`quarry_stage4` (sichtbar weiterentwickelt) · Baustelle: `quarry_construction.glb`
...
```
> Stufen: `farm_stage2`…`farm_stage4` (sichtbar weiterentwickelt) · Baustelle: `farm_construction.glb`
...
```
> Stufen: `well_stage2`…`well_stage2` (sichtbar weiterentwickelt) · Baustelle: `well_construction.glb`
...
```
> Stufen: `water_pump_stage2`…`water_pump_stage3` (sichtbar weiterentwickelt) · Baustelle: `water_pump_construction.glb`
...
```
> Stufen: `warehouse_stage2`…`warehouse_stage2` (sichtbar weiterentwickelt) · Baustelle: `warehouse_construction.glb`
...
```
> Baustelle optional: `depot_construction.glb`
...
```
> Baustelle optional: `waterworks_construction.glb`
...
```
> Stufen: `market_stage2`…`market_stage2` (sichtbar weiterentwickelt) · Baustelle: `market_construction.glb`
...
```
> Baustelle optional: `supermarket_construction.glb`
...
```
> Baustelle optional: `bakery_construction.glb`
...
```
> Stufen: `fire_station_stage2`…`fire_station_stage2` (sichtbar weiterentwickelt) · Baustelle: `fire_station_construction.glb`
...
```
> Stufen: `police_station_stage2`…`police_station_stage2` (sichtbar weiterentwickelt) · Baustelle: `police_station_construction.glb`
...
```
> Stufen: `hospital_stage2`…`hospital_stage2` (sichtbar weiterentwickelt) · Baustelle: `hospital_construction.glb`
...
```
> Stufen: `trading_post_stage2`…`trading_post_stage3` (sichtbar weiterentwickelt) · Baustelle: `trading_post_construction.glb`
...
```
> Baustelle optional: `shop_small_construction.glb`
...
```
> Stufen: `office_stage2`…`office_stage3` (sichtbar weiterentwickelt) · Baustelle: `office_construction.glb`
...
```
> Baustelle optional: `power_plant_construction.glb`
...
```
> Baustelle optional: `wind_farm_construction.glb`
...
```
> Stufen: `park_stage2`…`park_stage2` (sichtbar weiterentwickelt) · Baustelle: `park_construction.glb`
...
```
> Baustelle optional: `playground_construction.glb`
...
```
> Baustelle optional: `deco_tree_construction.glb`
...
```
> Baustelle optional: `deco_flowerbed_construction.glb`
...
```
> Baustelle optional: `deco_fountain_construction.glb`
...
```
> Baustelle optional: `deco_bench_construction.glb`
