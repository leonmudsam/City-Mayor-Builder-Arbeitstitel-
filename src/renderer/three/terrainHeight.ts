...
// (`tools/bakeWorld.mjs` → `worldHeight.gen.ts`, 769×769 Uint16-Samples,
...
//
// Scale convention: 1 tile ≈ 4 m; Wasserlinie = y 0; Gipfel ≈ 20 Einheiten
 ...
 * bebaubares Land ~0.05–3, Fels ab ~4.5, Gipfel bis 20.
 */
