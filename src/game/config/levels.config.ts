...
export const levelsConfig: LevelDef[] = [
  ...
  { level: 2, xpRequired: 36, unlocks: ['sawmill'], rewards: { money: 15_000 } },
  { level: 3, xpRequired: 130, unlocks: ['well', 'mayor_house'], rewards: { money: 24_000, gold: 10 } },
  // From L4 up the curve stretches: growth demands planning, not spamming (§1/§3).
  { level: 4, xpRequired: 310, unlocks: ['farm', 'quarry'], rewards: { money: 36_000 } },
  { level: 5, xpRequired: 620, unlocks: ['market', 'trading_post'], rewards: { money: 55_000, gold: 15 } },
  ...
  { level: 9, xpRequired: 3950, unlocks: ['apartment', 'bakery'], rewards: { money: 300_000, gold: 25 } },
  ...
  { level: 11, xpRequired: 8200, unlocks: ['power_plant', 'waterworks'], rewards: { money: 700_000, gold: 30 } },
  { level: 12, xpRequired: 11_500, unlocks: ['wind_farm', 'residential_tower', 'supermarket'], rewards: { money: 950_000 } },
